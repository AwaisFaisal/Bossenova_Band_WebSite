    ...
    class Slider {
      constructor(slider) {
        ...
        this.navButtons = Array.from(
          slider.querySelectorAll(".galleryNavButton")
        );
        ...
        if (
          ...
          console.error(
            "One or more required elements are missing in the slider"
          );
          return;
        }
      ...
      handleNavigation(direction) {
        const nextIndex =
          (this.currentSlideIndex + direction + this.navButtons.length) %
    ...
    <div className="galleryMainContainer">
      <div className="galleryImageSlider">
        ...
        <section className="gallerySliderContent">
          <button
            type="button"
            className="galleryControlButton galleryPrevButton"
          >
            <svg
              width="16"
              height="16"
          ...
          <button
            type="button"
            className="galleryControlButton galleryNextButton"
          >
            <svg
              width="16"
              height="16"
